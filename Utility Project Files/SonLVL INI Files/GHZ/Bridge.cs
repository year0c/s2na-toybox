...
namespace S2ObjectDefinitions.GHZ
{
	class Bridge : ObjectDefinition
	{
		...
		{
			byte[] artfile = ObjectHelper.OpenArtFile("../../art/nemesis/S1/GHZ Bridge.nem", CompressionType.Nemesis);
			string mapfile = "../../mappings/sprite/Bridge (GHZ).asm";
