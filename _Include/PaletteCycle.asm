...
loc_1F38:
		lea	(v_palette_line_4+$12).w,a1
		move.l	(a0,d0.w),(a1)+
		move.l	4(a0,d0.w),(a1)
		lea	(Pal_HPZCyc2).l,a0
		lea	(v_palette_water_line_4+$12).w,a1
		move.l	(a0,d0.w),(a1)+
		move.l	4(a0,d0.w),(a1)
...
PalCycle_EHZ:
		...
		andi.w	#3,d0
		lsl.w	#3,d0
		move.l	(a0,d0.w),(v_palette_line_2+6).w
		move.l	4(a0,d0.w),(v_palette_line_2+$1C).w
