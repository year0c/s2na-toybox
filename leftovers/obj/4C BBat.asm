...
Obj4C_PB:
		...
		move.w	Obj4C_PB_Index(pc,d0.w),d1
		jmp	Obj4C_PB_Index(pc,d1.w)
; ---------------------------------------------------------------------------
Obj4C_PB_Index:	dc.w Obj4C_PB_Init-Obj4C_PB_Index
		dc.w Obj4C_PB_Init.loc_16DA2-Obj4C_PB_Index
		dc.w Obj4C_PB_SubIndex.loc_16E10-Obj4C_PB_Index
; ---------------------------------------------------------------------------

Obj4C_PB_Init:
		move.l	#Map_Obj4C_PB,obMap(a0)
...
.loc_16DA2:
		...
		move.w	Obj4C_PB_SubIndex(pc,d0.w),d1
		jsr	Obj4C_PB_SubIndex(pc,d1.w)
		bsr.w	Obj4C_PB_SubIndex.sub_16DC8
		lea	(Ani_Obj4C_PB).l,a1
		bsr.w	$15D78+$47A	;	JmpTo7_AnimateSprite
		bra.w	$15D78+$474	;	JmpTo5_MarkObjGone
; ---------------------------------------------------------------------------
Obj4C_PB_SubIndex:	dc.w .loc_16F2E-Obj4C_PB_SubIndex
		dc.w .loc_16F66-Obj4C_PB_SubIndex
		dc.w .loc_16F72-Obj4C_PB_SubIndex
...
.loc_16E10:
		...
		bsr.w	.sub_16EB0
		bsr.w	.sub_16E30
		bsr.w	$15D78+$480	;	JmpTo7_ObjectMove
		lea	(Ani_Obj4C_PB).l,a1
		bsr.w	$15D78+$47A	;	JmpTo7_AnimateSprite
		bra.w	$15D78+$474	;	JmpTo5_MarkObjGone
; ---------------------------------------------------------------------------
