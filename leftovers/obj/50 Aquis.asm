...
Obj50_PB:
		...
		move.w	Obj50_PB_Index(pc,d0.w),d1
		jmp	Obj50_PB_Index(pc,d1.w)
; ---------------------------------------------------------------------------
Obj50_PB_Index:	dc.w Obj50_PB_Init-Obj50_PB_Index
		dc.w loc_1502E-Obj50_PB_Index
		dc.w Obj50_PB_SubIndex.loc_16006-Obj50_PB_Index
		dc.w Obj50_PB_SubIndex.loc_16030-Obj50_PB_Index
		dc.w Obj50_PB_Routine08-Obj50_PB_Index
		dc.w Obj50_PB_Routine0A-Obj50_PB_Index
; ---------------------------------------------------------------------------
...
loc_1502E:
		lea	(Ani_Obj50_PB).l,a1
		bsr.w	$14F5C+$872	;	JmpTo4_AnimateSprite
		move.w	#$39C,(v_waterpos1).w
		moveq	#0,d0
		move.b	ob2ndRout(a0),d0
		move.w	Obj50_PB_SubIndex(pc,d0.w),d1
		jsr	Obj50_PB_SubIndex(pc,d1.w)
		bsr.w	Obj50_PB_SubIndex.sub_161D8
		bra.w	$14F5C+$86C	;	JmpTo3_MarkObjGone
; ---------------------------------------------------------------------------
Obj50_PB_SubIndex:	dc.w .loc_16046-Obj50_PB_SubIndex
		dc.w .loc_16058-Obj50_PB_SubIndex
		dc.w .loc_16066-Obj50_PB_SubIndex
; ---------------------------------------------------------------------------
...
.loc_16006:
		...
		tst.b	obID(a1)
		beq.w	$14F5C+$866	;	JmpTo5_DeleteObject
		cmpi.b	#id_Obj50,obID(a1)
		bne.w	$14F5C+$866	;	JmpTo5_DeleteObject
		btst	#7,obStatus(a1)
		bne.w	$14F5C+$866	;	JmpTo5_DeleteObject
		lea	(Ani_Obj50_PB).l,a1
		bsr.w	$14F5C+$872	;	JmpTo4_AnimateSprite
		bra.w	$14F5C+$860	;	JmpTo5_DisplaySprite
; ---------------------------------------------------------------------------
...
.loc_16066:
		bsr.w	$14F5C+$878	;	JmpTo4_ObjectMoveAndFall
		bsr.w	Obj50_PB_Routine0A.sub_162DE
		bsr.w	.sub_16078
		bsr.w	.sub_160F4
		rts
...
.loc_1639A:
		bra.w	$14F5C+$866	;	JmpTo5_DeleteObject
; ---------------------------------------------------------------------------
