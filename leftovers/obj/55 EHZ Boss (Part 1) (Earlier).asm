...
Obj55_PB2:
		...
		move.w	Obj55_PB2_Index(pc,d0.w),d1
		jmp	Obj55_PB2_Index(pc,d1.w)
; ===========================================================================
Obj55_PB2_Index:	dc.w Obj55_PB2_Init-Obj55_PB2_Index
		dc.w Obj55_PB2_Init.loc_18302-Obj55_PB2_Index
		dc.w Obj55_PB2_Init.loc_18340-Obj55_PB2_Index
		dc.w Obj55_PB2_Init.loc_18372-Obj55_PB2_Index
		dc.w Obj55_PB2_Init.loc_18410-Obj55_PB2_Index
; ===========================================================================
; loc_181E4:
Obj55_PB2_Init:
		move.l	#Map_Obj55_PB2,obMap(a0)
...
.loc_18294:
		...
		_move.b	#id_Obj55,obID(a1)
		move.l	a0,objoff_34(a1)
		move.l	#Map_Obj55a_PB2,obMap(a1)
...
.loc_183BA:
		...
		bne.w	$1718C+$408	;	JmpTo8_DisplaySprite
		rts
; ===========================================================================
...
.loc_183D4:
		addq.b	#2,obRoutine(a0)
		move.l	#Map_Obj55b_PB2,obMap(a0)
