...
Obj09_Normal_PB:
		...
		move.w	Obj09_Index_PB(pc,d0.w),d1
		jmp	Obj09_Index_PB(pc,d1.w)
; ---------------------------------------------------------------------------
Obj09_Index_PB:	dc.w .loc_1A3DC-Obj09_Index_PB
		dc.w .loc_1A41C-Obj09_Index_PB
		dc.w S1SS_FixCamera_PB.loc_1A618-Obj09_Index_PB
		dc.w S1SS_FixCamera_PB.loc_1A66C-Obj09_Index_PB
; ---------------------------------------------------------------------------
...
Obj09_Move_PB:
		...
		beq.s	.loc_1A4A4
		bsr.w	Obj09_MoveLeft_PB

.loc_1A4A4:
		btst	#bitR,(v_jpadhold2).w
		beq.s	.loc_1A4B0
		bsr.w	Obj09_MoveRight_PB
