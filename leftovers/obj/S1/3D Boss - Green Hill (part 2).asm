...
.loc_17916:
		bra.w	BGHZ_PB_ShipStart.loc_177E6
; ===========================================================================

BGHZ_PB_ShipMove:
		subq.w	#1,objoff_3C(a0)
		bpl.s	BGHZ_PB_Reverse
		addq.b	#2,ob2ndRout(a0)
		move.w	#$40-1,objoff_3C(a0)
		move.w	#$100,obVelX(a0) ; move the ship sideways
		cmpi.w	#boss_ghz_x+$A0,objoff_30(a0)
		bne.s	BGHZ_PB_Reverse
...
.loc_17A5A:
		move.b	d1,obAnim(a0)
		subq.b	#2,d0
		bne.s	BGHZ_PB_FaceDisp
		move.b	#6,obAnim(a0)
		tst.b	obRender(a0)
		bpl.s	BGHZ_PB_FaceDel

BGHZ_PB_FaceDisp:
		bra.s	BGHZ_PB_Display
; ===========================================================================
...
BGHZ_PB_FlameMain:	; Routine 6
		...
		move.b	#$B,obAnim(a0)
		tst.b	obRender(a0)
		bpl.s	BGHZ_PB_FlameDel
		bra.s	BGHZ_PB_FlameDisp
; ===========================================================================

.loc_17A96:
		move.w	obVelX(a1),d0
		beq.s	BGHZ_PB_FlameDisp
		move.b	#8,obAnim(a0)
