...
; ---------------------------------------------------------------------------
Map_Over:	include	"mappings/sprite/S1/Game Over.asm"
...
M_Got_TBonus:	spriteHeader	; Time Bonus tally
	...
	spritePiece	$28, -8, 4, 2, $7F0, 1, 1, 3, 1	; Tally (first four digits)
...
M_Got_RBonus:	spriteHeader	; Ring Bonus tally
	...
	spritePiece	-$A, -9, 2, 1, $6E, 0, 0, 0, 0	; Small oval (upper half)
	spritePiece	-$A, -1, 2, 1, $6E, 1, 1, 0, 0	; Small oval (lower half)
	spritePiece	$28, -8, 4, 2, $7F8, 1, 1, 3, 1	; Tally (first four digits)
	spritePiece	$48, -8, 1, 2, $170, 0, 0, 0, 0	; Tally (second four digits)
M_Got_RBonus_End
	even
...
;	spritePiece	-$50, -8, 4, 2, $7D1, 1, 1, 3, 1; "CONT"
;	spritePiece	-$30, -8, 4, 2, $7D9, 1, 1, 3, 1; "INUE" and small oval (left half)
;	spritePiece	-$10, -8, 1, 2, $7E1, 1, 1, 3, 1; Small oval (right half)
;	spritePiece	$40, -8, 2, 3, $7E3, 1, 1, 0, 0	; Mini Sonic (foot down)
...
;	spritePiece	-$30, -8, 4, 2, $7D9, 1, 1, 3, 1; "INUE" and small oval (left half)
;	spritePiece	-$10, -8, 1, 2, $7E1, 1, 1, 3, 1; Small oval (right half)
;	spritePiece	$40, -8, 2, 3, $7E9, 1, 1, 0, 0	; Mini Sonic (foot up)
	dc.w $F80D, $FFD1, $7FC8, $FFB0
	dc.w $F80D, $FFD9, $7FD4, $FFD0
	dc.w $F801, $FFE1, $7FE0, $FFF0
